 ...
 * @param write_bit    Indicate the page directory is in read or write mode
 * @param user_supervisor_bit Indicate the page directory is isn user mode or supervisor mode
 * @param write_through Indicate write_through caching is disabled or not
 * @param cache_disable Indicate cache disabled or not
 * @param dirty Indicate that the page content has been changed
 * @param use_pagesize_4_mb Indicate that the page size is 4 mb 
 */
 ...
 * @param pat             Indicate if Page Attribute Table is supported
 * @param higher_address  Bits 39:32 referenced in the physical address of page frame
